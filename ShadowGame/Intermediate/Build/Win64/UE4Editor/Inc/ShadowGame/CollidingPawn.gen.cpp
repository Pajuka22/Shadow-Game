...
#include "ShadowGame/CollidingPawn.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SHADOWGAME_API UClass* Z_Construct_UClass_ACollidingPawn_NoRegister();
	SHADOWGAME_API UClass* Z_Construct_UClass_ACollidingPawn();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACollidingPawn_Statics::NewProp_SphereVisual_MetaData[] = {
		{ "Category", "CollidingPawn" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "CollidingPawn.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACollidingPawn_Statics::NewProp_SphereVisual = { "SphereVisual", nullptr, (EPropertyFlags)0x0010000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACollidingPawn, SphereVisual), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACollidingPawn_Statics::NewProp_SphereVisual_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACollidingPawn_Statics::NewProp_SphereVisual_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACollidingPawn_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACollidingPawn_Statics::NewProp_SphereVisual,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ACollidingPawn_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ACollidingPawn_Statics::PropPointers),
		0,
		0x008000A0u,
	...
	IMPLEMENT_CLASS(ACollidingPawn, 2586641109);
	template<> SHADOWGAME_API UClass* StaticClass<ACollidingPawn>()
	{
		return ACollidingPawn::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACollidingPawn(Z_Construct_UClass_ACollidingPawn, &ACollidingPawn::StaticClass, TEXT("/Script/ShadowGame"), TEXT("ACollidingPawn"), false, nullptr, nullptr, nullptr);
